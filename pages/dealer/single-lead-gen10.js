...
(function () {
  ...
  function render() {
    ...
    $('#tl-g').innerHTML = tl.map(function (t) { return '<div class="ar ar--' + t[3] + '" title="' + esc(t[2]) + '"><span class="ar__n">' + esc(t[0]) + '</span><span class="ar__b"><span class="ar__l"><span class="full">' + t[1] + '</span><span class="short">' + t[1] + '</span></span><span class="ar__m"><i style="--w:' + (typeof t[0] === 'number' ? Math.min(100, t[0] * 12) : 100) + '%"></i></span></span><span class="ar__p">' + esc(t[2]) + '</span></div>'; }).join('');
